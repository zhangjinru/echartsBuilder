...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <script type="text/javascript" src="../js/jquery-1.7.2.js"></script>
  <script type="text/javascript" src="../web/saleOrderTest.js"></script>
<title>Insert title here</title>
</head>
<body>
<input id="jsonData" type= "hidden"  value=<%=request.getAttribute("jsonData")%> type= "hidden"/>
...
<div id="queryDiv" style= "width:1000px;height:200px;margin-left:auto;margin-right:auto;">
  ...
  <table cellpadding="10">
  	<tr >
  		...
  		<option value="signData" label="日期"></option>
  ...
  <table  cellpadding="10">
  	<tr >
  		<td width="400px">日期：<input id ="startSignData"  name ="startSignData" type = 'date'>-&nbsp;<input id ="endSignData" type = 'date'>
  		</td>
